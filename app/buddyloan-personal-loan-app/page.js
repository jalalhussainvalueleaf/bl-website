...
async function fetchData() {
  const res = await fetch(`${ConfigData.blogAPI}/pages/21859`);
  if (!res.ok) {
...
export default function Page() {
  ...
  return (
    <>
      <div className="mt-20 flex min-h-[400px] items-center justify-between bg-gray-200 px-12 bg-[url('https://buddyloan-wordpress-blog.s3.ap-south-1.amazonaws.com/blog/wp-content/uploads/2025/01/09163432/mobile_bannerbg.png')] bg-cover bg-center bg-no-repeat">
        {/* <h1 className="text-5xl font-semibold text-bl-blue" dangerouslySetInnerHTML={{__html:post?.title.rendered || ''}}/> */}
        <div>
          <h1 className="text-3xl">Buddy Loan - Instant Personal Loan App</h1>
          <p className="py-6">Now get super-fast Personal & Business loan approvals at just 11.99% p.a.</p>
          <ul class="ullist">
            <li><b>Personal Loan - Up to ₹15 Lakhs</b></li>
            <li><b>Business Loan - Up to ₹50 Lakhs</b></li>
            <li><b>80% Approval Rate</b></li>
            <li><b>Instant Disbursal</b></li>
            <li><b>Paperless Documentation</b></li>
         </ul>
         <p className="py-6">Download the app now!</p>
         <div className="flex gap-4">
         <Link href="https://play.google.com/store/apps/details?id=com.buddyloan.vls&referrer=utm_source%3DWebsite%26utm_medium%3DDownloadButton"><img src="/images/playstore_btn.png" className="h-10"/></Link>
         <Link href="https://apps.apple.com/in/app/buddy-loan-personal-loan/id1552911697?utm_medium=DownloadButton&utm_source=SEO&utm_campaign=bl2&la=1"><img src="/images/appstore_btn.png" className="h-10"/></Link> 
