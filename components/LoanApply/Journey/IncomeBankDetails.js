...
<div class="p-4 bg-gray-50">
  ...
  <h2 class="text-lg font-semibold text-gray-800 mt-6 mb-2">Terms and Conditions:</h2>
  ...
  <h3 class="text-md font-medium text-gray-800 mt-4 mb-2">Governing Law and Jurisdiction</h3>
  <p class="mb-4 text-gray-700">
  ...
  <h3 class="text-md font-medium text-gray-800 mt-4 mb-2">Definitions:</h3>
  <ul class="list-disc pl-6 text-gray-700">
    <li class="mb-2">
      <strong class="font-semibold">Business Day:</strong> A day (other than a public holiday) on which banks are open for general business in Mumbai.
    </li>
    <li class="mb-2">
      <strong class="font-semibold">Credit Information Report:</strong> The credit information / scores/ aggregates / variables / inferences or reports which shall be generated by Experian.
    </li>
    <li class="mb-2">
      <strong class="font-semibold">Credit Score:</strong> The score which shall be mentioned on the Credit Information Report which shall be computed by Experian.
    </li>
    <li class="mb-2">
      <strong class="font-semibold">CICRA:</strong> The Credit Information Companies (Regulation) Act, 2005 read with the Credit Information Companies Rules, 2006 and the Credit Information Companies Regulations, 2006, and shall include any other rules and regulations prescribed thereunder.
    </li>
  </ul>

  <p class="mt-6 mb-4 text-gray-700">
  ...
  <p class="text-gray-500 mt-6">Powered By Experian</p>
</div>
